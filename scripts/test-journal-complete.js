...
assert(html.includes("app.js?v=271"), "cache app.js v=267");
  assert(html.includes("app.css?v=228"), "cache app.css v=228");
  assert(html.includes("lib/review-merge.js?v=24"), "cache review-merge v=22");
