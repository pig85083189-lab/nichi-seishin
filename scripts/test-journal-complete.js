...
assert(html.includes("app.js?v=262"), "cache app.js v=262");
  assert(html.includes("app.css?v=226"), "cache app.css v=226");
  assert(html.includes("lib/review-merge.js?v=19"), "cache review-merge v=19");
