...
assert(html.includes("app.js?v=249"), "cache app.js v=249");
assert(html.includes("app.css?v=216"), "cache app.css v=216");
assert(html.includes("lib/review-merge.js?v=12"), "cache review-merge v=12");
