...
assert(html.includes("app.js?v=284"), "cache app.js v=267");
  assert(html.includes("app.css?v=237"), "cache app.css v=228");
  assert(html.includes("lib/review-merge.js?v=29"), "cache review-merge v=22");
