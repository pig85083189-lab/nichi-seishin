...
assert(html.includes("app.js?v=252"), "cache app.js v=252");
  assert(html.includes("app.css?v=218"), "cache app.css v=218");
  assert(html.includes("lib/review-merge.js?v=13"), "cache review-merge v=13");
