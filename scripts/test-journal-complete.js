...
assert(html.includes("app.js?v=283"), "cache app.js v=267");
  assert(html.includes("app.css?v=236"), "cache app.css v=228");
  assert(html.includes("lib/review-merge.js?v=28"), "cache review-merge v=22");
