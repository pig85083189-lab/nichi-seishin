...
assert(html.includes("app.js?v=247"), "cache app.js v=247");
assert(html.includes("app.css?v=214"), "cache app.css v=214");
assert(html.includes("lib/review-merge.js?v=10"), "cache review-merge v=10");
