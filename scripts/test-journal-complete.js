...
assert(html.includes("app.js?v=248"), "cache app.js v=248");
assert(html.includes("app.css?v=215"), "cache app.css v=215");
assert(html.includes("lib/review-merge.js?v=11"), "cache review-merge v=11");
