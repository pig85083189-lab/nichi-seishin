...
assert(app.includes("function generateReflectionV3"), "正式 04 主路徑已接 reflection-v3");
assert(app.includes("function generateThinkV2Ask"), "think-v2 仍保留相容");
...
assert(bodyFold.includes("身心覺察"), "03 標題");
