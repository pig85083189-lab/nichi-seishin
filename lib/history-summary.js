(function (root, factory) {
  ...
  function collectBodySearch(journal, parts) {
    ...
    const mind = journal && journal.bodyMind && typeof journal.bodyMind === "object" ? journal.bodyMind : {};
    pushSearch(parts, mind.text);
    pushSearch(parts, mind.insight);
    pushSearch(parts, mind.support);
