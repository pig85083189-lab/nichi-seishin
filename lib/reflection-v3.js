...
function reflectionV3UserPrompt(body) {
  ...
  return `請依今天 01～03 產出一句 coreQuote ＋ 三個洞察。不要訪談。不要再要她回答。不要把 03 AI 假設寫成事實。
完整讀完 USER RAW。省略號後面的句子也要讀。
每個 item 先 title + insight，最後才決定要不要 question。白話。不要抽象詞。推測用會不會／有沒有可能。
