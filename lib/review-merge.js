(function (root, factory) {
  ...
  function emptyAwarenessV3() {
    return { variant: "awareness-v3", sourceSig: "", items: [], selectedIds: [], generatedAt: "" };
  }
  ...
  function mergeAwarenessV3(older, newer) {
    ...
    if (stamp(b.generatedAt) >= stamp(a.generatedAt) || (b.sourceSig && b.sourceSig !== a.sourceSig)) {
      return { ...b, selectedIds: b.selectedIds.length ? b.selectedIds : a.sourceSig === b.sourceSig ? a.selectedIds : [] };
    }
    return { ...a, selectedIds: b.selectedIds.length ? b.selectedIds : a.selectedIds };
  }
