...
async function runOpen(callAi, ctx, usedPast) {
  ...
  if ((looksNoUnknownLeft(raw, known)) && !seeGroundedInRaw(see, raw)) {
  ...
  if (reasonData && reasonData.stop && looksNoUnknownLeft(raw, known) && !seeGroundedInRaw(see, raw)) {
  ...
  if (stage === "converged" && !written.question && looksThinAmbiguous(raw)) {
